    ...
    <template x-teleport="body">
        ...
        >
            ...
            <div
                ...
                x-transition.opacity
            >
                <svg xmlns="http://www.w3.org/2000/svg" class="inline size-20 text-primary" fill="none"
                ...
                <div class="mt-4">
                    ...
                    <div class="flex justify-center gap-2 mt-6">
                        <button class="btn bg-slate-200 text-slate-800 hover:bg-slate-300"
                            @click="show = false; if(noCallback) noCallback()">Batal</button>
                        <button class="btn bg-primary text-white hover:bg-primary-focus"
                            @click="show = false; if(yesCallback) yesCallback()">Lanjut</button>
                    </div>
                </div>
            </div>
        </div>
