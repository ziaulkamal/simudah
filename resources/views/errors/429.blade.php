        ...
        <div class="max-w-md p-6 text-center">
          <div class="w-full">
            <img
              ...
              src="{{ asset('images/illustrations/error-429.svg') }}"
              alt="image"
            />
            <img
              class="w-full"
              x-show="$store.global.isDarkModeEnabled"
              src="{{ asset('images/illustrations/error-429-dark.svg') }}"
              alt="image"
            />
          </div>
          ...
          <p class="pt-2 text-slate-500 dark:text-navy-200">
            Pengguna telah mengirim terlalu banyak permintaan dalam jangka waktu tertentu. Silakan coba lagi nanti.
          </p>
        </div>
      </main>
    </div>
