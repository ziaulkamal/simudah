...
<html lang="en">
  ...
  <body x-data x-bind="$store.global.documentBody">
    ...
    >
      <main
        class="main-content w-full place-content-center px-[var(--margin-x)]"
      >
        <div class="flex flex-col items-center p-6 text-center">
          <div class="w-full max-w-xs">
            <img
              ...
              src="{{ asset('images/illustrations/error-404.svg') }}"
              alt="image"
            />
            <img
              class="w-full"
              x-show="$store.global.isDarkModeEnabled"
              src="{{ asset('images/illustrations/error-404-dark.svg') }}"
              alt="image"
            />
          </div>
          <p
          ...
          >
            Oops. Halaman yang anda cari kosong.
          </p>
          <p class="pt-2 text-slate-500 dark:text-navy-200">
            Harap periksa kembali aktivitas yang anda lakukan. Silahkan kembali ke Dashboard
          </p>
